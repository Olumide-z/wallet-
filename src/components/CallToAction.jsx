...
const cards = [
  ...
  {
    title: 'Earn Rewards by staking ETH Unlock the potential of your staked Coin!',
    button: 'Try Now',
  },
  {
    title: 'Maximize your returns and explore new opportunities within the decentralized finance (DeFi) ecosystem.',
    button: 'Try Now',
  },
  {
        ...
        {cards.map((card, index) => (
          <SwiperSlide key={index}>
            <div className="bg-[#171717] text-white rounded-2xl shadow-lg p-8 h-fit flex flex-col justify-between">
              <div>
                <h3 className="text-[2rem] leading-12 font-semibold mb-4">{card.title}</h3>
                 </div>
              <Link href="/wallet">
